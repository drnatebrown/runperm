...
class lf_permutation_impl : public rlbwt_permutation<lf_permutation_impl<data_columns_t, integrated_move_structure, store_absolute_positions, exponential_search, alphabet_t, table_t>,
                         data_columns_t, integrated_move_structure, store_absolute_positions, exponential_search, alphabet_t, table_t> {
    using base = rlbwt_permutation<lf_permutation_impl, data_columns_t, integrated_move_structure, store_absolute_positions, exponential_search, alphabet_t, table_t>;
...
template<bool store_absolute_positions = DEFAULT_STORE_ABSOLUTE_POSITIONS,
         ...
         typename alphabet_t = nucleotide,
         template<typename> class table_t = move_vector>
using lf_move_impl = lf_permutation_impl<empty_data_columns, false, store_absolute_positions, exponential_search, alphabet_t, table_t>;

template<typename alphabet_t=nucleotide>
using lf_move_impl_default = lf_move_impl<DEFAULT_STORE_ABSOLUTE_POSITIONS, DEFAULT_EXPONENTIAL_SEARCH, alphabet_t, move_vector>;
