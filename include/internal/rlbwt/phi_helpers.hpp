...
namespace phi {
    ...
    inline std::tuple<IntVec, IntVec> rlbwt_to_phi(const std::vector<uchar>& bwt_heads, const std::vector<ulint>& bwt_run_lengths, LFType& lf, size_t* domain = nullptr, ulint* max_length = nullptr) {
    ...
    template<typename LFType>
    inline std::tuple<IntVec, IntVec> rlbwt_to_phi_tau_inv(const std::vector<uchar>& bwt_heads, const std::vector<ulint>& bwt_run_lengths, LFType& lf, size_t* domain = nullptr, ulint* max_length = nullptr) {
        IntVec phi_lengths(lf.runs(), bit_width(lf.domain() - 1));
...
namespace invphi {
    ...
    template<typename LFType>
    inline std::tuple<IntVec, IntVec> rlbwt_to_invphi(const std::vector<uchar>& bwt_heads, const std::vector<ulint>& bwt_run_lengths, LFType& lf, size_t* domain = nullptr, ulint* max_length = nullptr) {
    ...
    template<typename LFType>
    inline std::tuple<IntVec, IntVec> rlbwt_to_invphi_tau_inv(const std::vector<uchar>& bwt_heads, const std::vector<ulint>& bwt_run_lengths, LFType& lf, size_t* domain = nullptr, ulint* max_length = nullptr) {
        IntVec invphi_lengths(lf.runs(), bit_width(lf.domain() - 1));
